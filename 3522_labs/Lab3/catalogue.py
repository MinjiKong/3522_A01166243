...
class Catalogue:
    ...
    def retrieve_resource_by_call_number(self, call_number):
        """
        A public method that encapsulates the retrieval of an resource with
    ...
    def add_item(self):
        ...
        found_resource = self.retrieve_resource_by_call_number(
    ...
    def remove_item(self, call_number):
        ...
        """
        found_resource = self.retrieve_resource_by_call_number(call_number)
        if found_resource:
